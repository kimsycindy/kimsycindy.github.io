...
export type IndexImagesQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexImagesQuery = { profile?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
